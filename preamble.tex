...
% >>> Eigene Formatierungen
	...
	\newcommand{\abk}[1]{\gls{#1}} % Abkürzungen für Abkürzungsverzeichnis und Glossar
% >>> Eigene Formatierungen
...
\newacronym{ddr}{DDR}{Deutsche Demokratische Republik}
\newacronym{dvp}{DVP}{Deutsche Volkspolizei}
